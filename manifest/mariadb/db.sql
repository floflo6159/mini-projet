...
INSERT INTO `Webook`.`Livre` (`idLivre`, `Titre`, `Auteur`, `Genre`, `Description`) VALUES (
  1, 'Ton absence n’est que ténèbres', 'Jón Kalman Stefánsson', 'Roman', 'Prix du livre étranger 2022.
...
INSERT INTO `Webook`.`Livre` (`idLivre`, `Titre`, `Auteur`, `Genre`, `Description`) VALUES (
  2, 'Celui qui veille', 'Louise Erdrich', 'Roman', 'Prix Pulitzer 2021.
...
INSERT INTO `Webook`.`Livre` (`idLivre`, `Titre`, `Auteur`, `Genre`, `Description`) VALUES (
  7, 'Look Back', 'Tatsuki Fujimoto ', 'Manga', 'Fujino est une élève de CM1 qui dessine des manga pour le journal de l’école. Elle est la star de sa classe grâce à ses dessins, mais elle apprend un jour qu’une certaine Kyomoto, une élève qui ne vient jamais à l’école, désire aussi être publiée dans le journal de l’école...' 
);

INSERT INTO `Webook`.`Livre` (`idLivre`, `Titre`, `Auteur`, `Genre`, `Description`) VALUES (
  8, 'Goodbye, Eri', 'Tatsuki Fujimoto', 'Manga', 'Tout est toujours aussi bien ficelé, on est tenu en haleine tout le long du récit grâce à des questions dont on obtient les réponses avec toujours ce découpage qu’on pourrait presque qualifier de fujimotesque tant c’est devenu sa marque de fabrique ! Quelle lecture émouvante, Fujimoto joue toujours aussi bien avec notre doute par rapport à ce qui est réel et ce qui ne l’est pas.'
);
...
INSERT INTO `Webook`.`Livre` (`idLivre`, `Titre`, `Auteur`, `Genre`, `Description`) VALUES (
  10, 'Connemara', 'Nicolas Mathieu', 'Roman', 'Hélène a bientôt quarante ans. Elle est née dans une petite ville de l’Est de la France. Elle a fait de belles études, une carrière, deux filles et vit dans une maison d’architecte sur les hauteurs de Nancy. Elle a réalisé le programme des magazines et le rêve de son adolescence : se tirer, changer de milieu, réussir. Et pourtant le sentiment de gâchis est là, les années ont passé, tout a déçu.
